...
public enum NotaFiscalTipoEmissao {
    ...
    NotaFiscalTipoEmissao(final String codigo, final String descricao) {
        this.codigo = codigo;
    ...
    public static NotaFiscalTipoEmissao valueOfCodigo(final String codigo) {
        for (final NotaFiscalTipoEmissao tipo : NotaFiscalTipoEmissao.values()) {
